            ...
            "contents": [
                {
                    "parts": [
                        {
                            "text": """Transcreva o áudio completo a seguir para texto. Separe o diálogo por locutor e interlocutor, indicando quem fala o quê. Se tiver dificuldade em entender alguma palavra, tente aproximar ao máximo. Não adicione informações que não estão presentes no áudio."""
                        },
                        {
                            "inlineData": {
